% Preferred (biblatex): Pdflatex -> biber -> Pdflatex -> Pdflatex
% Optional (bibtex): Pdflatex -> Bibtex -> Pdflatex -> Pdflatex
...
% -------------------------------------------------------------
% [Preferred] Use biblatex to manage references
\usepackage[
    doi=false,
    isbn=false,
    url=false,
...
% \addbibresource{biblatex.bib} % Add more bib files if needed
% -------------------------------------------------------------
...
% -------------------------------------------------------------
% Author info
%   - Symbols for corresponding authors and equal contributions
%       \ast, \dagger, \ddagger, \mathsection, \mathparagraph, 
%       |, \ast\ast, \dagger\dagger, \ddagger\ddagger
% -------------------------------------------------------------
\author[1,$\ast$]{Jia-Xin Zhong}
\author[1,$\ast$]{B Author}
\author[2,3,$\dagger$]{C Author}
\author[1,$\ddagger$]{D Author}
...
% Option 1
% \affil[*]{C.Author@psu.edu}
% \affil[$\dagger$]{D.Author@nju.edu.cn}

% Option 2
% \date{}
% Put email in date field
\date{\vspace{-1em}\small 
    \textsuperscript{$\ast$}These authors contributed equally\\
    % Email: 
    \textsuperscript{$\dagger$}C.Author@psu.edu;
    \textsuperscript{$\ddagger$}D.Author@nju.edu.cn
}
% -------------------------------------------------------------
...
ArXiv reference \cite{Zhong2026ObservationErraticNonHermitian}.
\lipsum[2]
